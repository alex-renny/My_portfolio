...
function Navbar() {
  ...
  return (
    <nav id="nav" className="bg-black w-full fixed top-0 z-10">
      <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
        <div className="relative flex h-16 items-center justify-between">
          ...
          <div className="absolute inset-y-0 left-0 flex items-center sm:hidden">
            <button
              type="button"
              className="hamburger relative inline-flex items-center justify-center rounded-md p-2 text-gray-400 hover:bg-gray-700 hover:text-white focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white"
          ...
          <div className="hidden sm:block sm:ml-6">
            <div className="flex space-x-4">
              ...
              <a href="#skillsection" className="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Skills</a>
              ...
              <a href="#contact" className="rounded-md px-3 py-2 text-sm font-medium text-gray-300 bg-gray-700 text-white">Contact</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className={`sm:hidden ${isOpen ? 'block' : 'hidden'}`} id="mobile-menu">
        <div className="space-y-1 px-2 pb-3 pt-2">
          ...
          <a href="#skillsection" className="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Skills</a>

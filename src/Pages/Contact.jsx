          ...
          <div className="contact-info-wrapper">
            <div className="contact-info-card">
              ...
              <div className="social-links">
                <a href="https://github.com/alex-renny" target="_blank" rel="noopener noreferrer" className="social-link" title="GitHub">
                ...
                <a href="https://linkedin.com/in/alex-renny" target="_blank" rel="noopener noreferrer" className="social-link" title="LinkedIn">
                  <svg viewBox="0 0 24 24" fill="currentColor">
